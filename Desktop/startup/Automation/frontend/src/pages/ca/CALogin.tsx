    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-extrabold leading-tight mb-2">Create account</h2>
            <p className="text-sm text-slate-100/90 mb-4 max-w-xs">
              Create your account to start automating GST, invoices and collaboration with CAs. Signup with phone + OTP or Google.
            </p>
            <ul className="space-y-2 mt-auto text-sm">
              <li>Fast OTP signup</li>
              <li>Firm & registration capture</li>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-sm sm:max-w-md">
              <AuthCard role="CA" onSuccess={handleSuccess} />
            </div>
          </div>
        </div>
      </main>
